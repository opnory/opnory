...
describe.skipIf(!APP_ID || !INSTALLATION_ID || !PRIVATE_KEY || !TEST_USER_A)("GitHubAccessExecutor - Live Sandbox Tests", () => {
    beforeAll(() => {
    ...
    describe.skipIf(!TEST_USER_B)("Scenario 3: Outside-org user -> AWAITING_EXTERNAL_ACCEPTANCE (no false success)", () => {
...
describe.skipIf(!process.env.OPNORY_LIVE_GITHUB_TESTS)("GitHubAccessExecutor - Live Test Configuration", () => {
