...
export declare function createGovernanceProvider(
...
export declare class GovernanceService {
  ...
  private auditStore;
  constructor(
    localProvider: LocalGovernanceProvider,
    entraProvider?: GovernanceProvider | undefined,
    oktaProvider?: GovernanceProvider | undefined,
    auditStore?: AuditEventStore,
  );
  private getProvider;
  submitGovernedRequest(
