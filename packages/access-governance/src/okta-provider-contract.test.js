...
import { OktaGovernanceProvider } from "@opnory/access-governance";
...
describe("OktaGovernanceProvider Contract Tests", () => {
    ...
    describe("submitRequest()", () => {
        it("should POST to /governance/api/v2/requests", async () => {
            ...
            const body = JSON.parse(oktaCall[1].body);
    ...
    describe("resolveEntitlement()", () => {
        ...
        it("should throw when governance config missing or wrong provider", async () => {
            ...
            const wrongProvider = { ...testEntitlementRef, governance: { ...testEntitlementRef.governance, provider: "entra" } };
...
//# sourceMappingURL=okta-provider-contract.test.js.map